...
A genuinely local-only project with no configured origin has nothing to freshen against and launches at its current commit, but the same clean-worktree refusal still applies to it.
